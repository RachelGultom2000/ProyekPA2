...
?>
        ...
        <div class="row">
			...
			<div class="col-sm-6 col-md-4">
				...
				<h4>
					...
					<br>
					<br>
					<button class="btn btn-danger" data-toggle="modal" data-target="#modal_dokumen">Jumlah dokumen yang masuk
						<span class="badge badge-light"><?php echo $num ?> </div>
					</button>

					<button class="btn btn-success" data-toggle="modal" data-target="#modal_dosen" style="margin-left:15px;">Dosen yang diundang
  ...
  <!-- dosen -->
        			...
        			<div class="modal-header">
          				<h4 class="modal-title">Dosen yang diundang</h4>
          				<button type="button" class="close" data-dismiss="modal">&times;</button>
        			</div>
